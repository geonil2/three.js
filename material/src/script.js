...
import { Material, MeshToonMaterial, Plane } from 'three'
...
const doorambientOcculusionTexture = textureLoader.load('/textures/door/ambientOcculusion.jpg')
...
//color는 위에 map처럼 따로 뺄 수 있는게 아니라 set을 써야해
